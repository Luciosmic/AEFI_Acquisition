...
from interface_v2.presenters.scan_presenter import ScanPresenter
...
from interface_v2.styles.theme import apply_dark_theme
...
def main():
    ...
    if use_startup:
        ...
        from interface_v2.ui_system_lifecycle.view_startup import StartupView
