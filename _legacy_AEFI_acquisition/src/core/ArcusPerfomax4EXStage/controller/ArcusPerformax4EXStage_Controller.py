...
class ArcusPerformax4EXStageController:
    ...
    def __init__(self, dll_path=None, params=None):
        ...
        try:
            ...
            print(f"[WARNING] Impossible de se connecter au stage: {e}")
            print("[WARNING] L'application fonctionnera en mode dégradé (sans contrôle du stage)")
            self.stage = None
            self.axis_mapping = {"x": 0, "y": 1, "z": 2, "u": 3}
            self.homing_service = None
