function E_rotated_quat = rotate_vector_field(E_x, E_y, E_z, theta_x, theta_y, theta_z)
% Author : Luis Saluden
% Date : 2024-10-04
    ...
    % Renvoie le champ de vecteurs tourné
    E_rotated_quat = E_rotated_quat; % Optional: can keep this line for clarity
end
