...
alwaysApply: true
description: 'SolidAI — Graphe de Pensée : Ossature DDD-Crew et Règles de Traversal [EXPÉRIMENTAL]'
---

# Standard: SolidAI — Graphe de Pensée : Ossature DDD-Crew et Règles de Traversal [EXPÉRIMENTAL]

⚠️ STATUT EXPÉRIMENTAL — Ces règles sont en cours de validation et peuvent évoluer. Ce standard définit l'ossature du graphe de pensée SolidAI en trois couches de stabilité décroissante (#domain, #app... :
