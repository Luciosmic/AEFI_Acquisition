...
class ScanControlPanel(QWidget):
    ...
    def _build_ui(self):
        ...
        self.input_speed = QLineEdit("N/A")
        self.input_speed.setEnabled(False)
        self.input_speed.setToolTip("Speed is controlled via Hardware Advanced Configurator")
        ...
        form_layout.addRow("Speed (Adv. Config):", self.input_speed)
